...
/***/ function(module, exports, __webpack_require__) {
	...
	var GreetMessage = (function (_Component) {
	  _inherits(GreetMessage, _Component);

	  function GreetMessage() {
	    _classCallCheck(this, GreetMessage);

	    _get(Object.getPrototypeOf(GreetMessage.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(GreetMessage, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'greet-message' },
	        ...
	        _react2['default'].createElement(
	          'a',
	          { href: 'javascript:void(0);', onClick: this.props.restartClicked },
	          'Restart'
	        )
	      );
	    }
	...
	var AskForName = (function (_Component2) {
	  _inherits(AskForName, _Component2);

	  function AskForName() {
	    _classCallCheck(this, AskForName);

	    _get(Object.getPrototypeOf(AskForName.prototype), 'constructor', this).apply(this, arguments);
	  }

	  _createClass(AskForName, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	        'div',
	        { className: 'ask-for-name' },
	        _react2['default'].createElement(
	          'p',
	          null,
	          'What is your name?'
	        ),
	        _react2['default'].createElement('input', { type: 'text', value: this.props.name, onChange: this.props.nameChanged }),
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.props.nameConfirmed.bind(null, this.props.name) },
	          'Confirm'
	        )
	      );
	    }
	...
	var RootComponent = (function (_Component3) {
	  _inherits(RootComponent, _Component3);
	  ...
	  _createClass(RootComponent, [{
	    key: 'render',
	    value: function render() {
	      var component = this.props.isNameConfirmed ? _react2['default'].createElement(GreetMessage, {
	        restartClicked: this.props.restartClicked,
	        name: this.props.name }) : _react2['default'].createElement(AskForName, {
	...
	var Gui = (function () {
	  ...
	  _createClass(Gui, [{
	    key: 'showAskForName',
	    value: function showAskForName() {
	      (0, _react.render)(_react2['default'].createElement(RootComponent, {
	        name: '',
	        isNameConfirmed: false,
	        restartClicked: this.restartClicked,
	        nameChanged: this.nameChanged.bind(this),
	        nameConfirmed: this.confirmNameButtonClicked }), document.getElementById('main'));
	    }
	  }, {
	    key: 'showGreetMessage',
	    value: function showGreetMessage(name) {
	      (0, _react.render)(_react2['default'].createElement(RootComponent, {
	        name: name,
	    ...
	    key: 'confirmNameButtonClicked',
	    value: function confirmNameButtonClicked(name) {}
	  }]);
